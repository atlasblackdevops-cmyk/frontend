    ...
    >
      ...
      <div className={classes.navbarMain}>
        <div className={classes.brandSection}>
          {!collapsed && (
            <Group align="center" gap="xs" onClick={() => setSwitcherOpen(true)} className={classes.farmSwitcherGroup}>
      ...
      <div className={classes.footer}>
          <UserButton collapsed={collapsed} handleLogout={() => void handleLogout()} />
      </div>
